...
mod InflationOracle {
    ...
    impl InflationOracleImpl of IInflationOracle<ContractState> {
        ...
        // Signature verified cryptographically using Poseidon hash + ECDSA over all data fields
        ...
        fn publish_data(
            ...
            // SIGNATURE VERIFICATION - cryptographically verify publisher signed this data
            let mut hash_data = ArrayTrait::new();
            hash_data.append(cpi_value.into());
            hash_data.append(cpi_yoy_bps.into());
            hash_data.append(tbill_3m_bps.into());
            hash_data.append(tbill_10y_bps.into());
            hash_data.append(fed_funds_bps.into());
            hash_data.append(data_timestamp.into());
            hash_data.append(caller.into());

            let message_hash = poseidon_hash_span(hash_data.span());
            ...
            assert!(is_valid, "Oracle: invalid signature");
